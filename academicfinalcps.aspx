<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="academicfinalcps.aspx.cs" Inherits="CandidatePlanofStudy.academicfinalcps" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <h3>Foundation Course Section</h3>
        ...
        <h3>Electives</h3>
         <div>
         <asp:GridView ID="GridViewelective" class="tbl1 srchresultssummary " runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSourceele" AutoGenerateEditButton="True">
            <Columns>
       ...
       <h3>Capstone</h3>
         <div>
        <asp:GridView ID="GridViewcap" runat="server" class="tbl1 srchresultssummary" AutoGenerateColumns="False" AutoGenerateEditButton="True" DataKeyNames="id" DataSourceID="SqlDataSourcecap">
            <Columns>
                <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                <asp:BoundField DataField="semester" HeaderText="semester" SortExpression="semester" />
                <asp:BoundField DataField="grade" HeaderText="grade" SortExpression="grade" />
        ...
        <asp:SqlDataSource ID="SqlDataSourcethe" runat="server" ConnectionString="<%$ ConnectionStrings:cpsdb %>" DeleteCommand="DELETE FROM [studentcpsfinal] WHERE [id] = @id" InsertCommand="INSERT INTO [studentcpsfinal] ([semester], [grade], [rubric], [courseid], [coursename], [units]) VALUES (@semester, @grade, @rubric, @courseid, @coursename, @units)" SelectCommand="SELECT [id], [semester], [grade], [rubric], [courseid], [coursename], [units] FROM [studentcpsfinal] WHERE (([Studentid] = @Studentid) AND ([type] = @type))" UpdateCommand="UPDATE [studentcpsfinal] SET [semester] = @semester, [grade] = @grade, [rubric] = @rubric, [courseid] = @courseid, [coursename] = @coursename, [units] = @units WHERE [id] = @id">
         ...
         <h3>Thesis</h3>
         <div>
        <asp:GridView ID="GridViewthe" runat="server" class="tbl1 srchresultssummary" AutoGenerateEditButton="True" DataSourceID="SqlDataSourcethe">
        </asp:GridView>
             </div>
         </div>
     <br /><br />
     <asp:Button ID="btnprint" Text="Print" runat="server" class="btn"/>
     <asp:Button ID="btndown" Text="Download" runat="server" class="btn"/>
