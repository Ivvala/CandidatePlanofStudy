<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="facultycinfdraft.aspx.cs" Inherits="CandidatePlanofStudy.facultycinfdraft" %>
...
.tbl1 {border:1px solid #F4ECEC; border-collapse:collapse;}
table {
  
    border-spacing:0;
}

th {background:#f8f7f7; border-left:1px solid #CCC;}
        .auto-style1 {
            border-collapse: collapse;
            font-size: 100%;
            vertical-align: rop;
