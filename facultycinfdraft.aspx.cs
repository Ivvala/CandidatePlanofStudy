...
{
    public partial class facultycinfdraft : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (rubric.Trim().ToUpper().Equals("SOFTWARE ENGINEERING"))
                {
                    ...
                    using (SqlDataAdapter sda1 = new SqlDataAdapter("select rubric,courseid,coursename,units from studentdraft where Studentid=@sid and type=@type", conrbc1))
                    {
                        sda1.SelectCommand.Parameters.AddWithValue("@sid", Studentid);
                        sda1.SelectCommand.Parameters.AddWithValue("@type", "F");
                    ...
                    {
                        sda1.SelectCommand.Parameters.AddWithValue("@sid", Studentid);
                        sda1.SelectCommand.Parameters.AddWithValue("@type", "C");
                        DataSet ds1 = new DataSet();
                        sda1.Fill(ds1);
