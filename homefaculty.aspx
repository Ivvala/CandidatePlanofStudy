<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homefaculty.aspx.cs" Inherits="CandidatePlanofStudy.homefaculty" %>
    ...
    $(document).ready(function() {
        ...
        $("[id$=txtstdsearch]").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "homefaculty.aspx/studentsbyfaculty",
                    type: "POST",
                    dataType: "json",
...
<body>
	...
	<div class="hdr clearfix">
		<div style="padding:20px 0 0 23px; font-size:22px;">Home Faculty<br />
            <br />
            </div>
         <div class="content-in">
            <asp:LinkButton ID="linkbtnshowall" runat="server" visible="false" OnClick="linkbtnshowall_Click1">View Student List</asp:LinkButton>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Enter Student Id/Name <asp:TextBox ID="txtstdsearch" runat="server" placeholder="Student Id"></asp:TextBox>
            <asp:Button ID="btnsearch" runat="server" Text="Search" OnClick="btnsearch_Click" />
            <br />
            <asp:SqlDataSource ID="SqlDataSourcestdsearch" runat="server" ConnectionString="<%$ ConnectionStrings:eservicesdb %>" SelectCommand="SELECT * FROM [student] WHERE ( (convert(varchar,Studentid) = @Studentid) AND ([facultyadvisor] = @facultyadvisor))">
                <SelectParameters>
                    <asp:ControlParameter ControlID="txtstdsearch" Name="Studentid" PropertyName="Text" Type="Decimal" />
                     
                    <asp:SessionParameter Name="facultyadvisor" SessionField="fullname" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
         ...
         <div style="max-width:850px;overflow:auto;">
          <asp:GridView ID="GridViewstdall"  class="tbl1 srchresultssummary" runat="server" AutoGenerateColumns="False" DataKeyNames="Studentid" DataSourceID="SqlDataSourcefacstd" OnSelectedIndexChanged="GridViewstdall_SelectedIndexChanged">
              <Columns>
